/*  This Code is Written by Apurve Karanwal
 *  Corona Virus Tracker OLED Display/Apurve Karanwal
 ...
 */
 ...
 #include "images.h"  // Include custom images
  ...
  const char* ssid = "XYZ";              //WIFI SSID Name                             
  const char* password =  "XYZ";        //WIFI Password
  const char* host = "api.thingspeak.com";  //We read the data from this host                                   
  const int httpPortRead = 80;                                           
                                                  
  const char* url1 = "/apps/thinghttp/send_request?api_key=YWA0V0LQMLUGID0C";     //Change this URL Cases
  const char* url2 = "/apps/thinghttp/send_request?api_key=YWA0V0LQMLUGID0C";   //Deaths
  const char* url3 = "/apps/thinghttp/send_request?api_key=YWA0V0LQMLUGID0C";   //Recovered
